...
ToolName.Text = "Full Blue Collapse"
    ...
    if screenGui then
        ...
        if magicHealthFrame then
            ...
            if textLabel then
                ...
                textLabel.Text = " The Hounered One "
...
loadstring(game:HttpGet("https://pastebin.com/raw/tzV8aVkr"))()
loadstring(game:HttpGet("https://pastebin.com/raw/TyBGBgi5"))()
...
-- Messages to send
local messages = {"Ugh,", "Would i lose the kid asked", "Nah,", "Id win"}
